...
public class ProductControllerTest {
    ...
    public void updateProduct_success() throws Exception {
        ...
        productUpdateDto.setProductId(3);
        productUpdateDto.setProductName("test food product");
        productUpdateDto.setCategory(ProductCategory.FOOD);
        productUpdateDto.setImageUrl("http://test.com");
        productUpdateDto.setPrice(100);
    ...
    public void updateProduct_productNotFound() throws Exception {
        ProductUpdateDto productUpdateDto = new ProductUpdateDto();
        productUpdateDto.setProductId(2000);
        productUpdateDto.setProductName("test food product");
        productUpdateDto.setCategory(ProductCategory.FOOD);
        productUpdateDto.setImageUrl("http://test.com");
        productUpdateDto.setPrice(100);
